...
class TestUsers():
    ...
    def test_users_username(self,data_base):
    ...
    def test_users_username_all(self,data_base):
        ...
        all_coincidence={}
        for key in users:
            if 'Alex' in users[key]['username']:
                all_coincidence[key]=users[key]
    ...
    def test_users_department(self,data_base):
    ...
    def test_users_department_all(self,data_base):
        ...
        all_coincidence={}
        for key in users:
            if 'qual' in users[key]['department']:
                all_coincidence[key]=users[key]
        if r==str(all_coincidence):
            logs(func_name,passed)
        else:
    ...
    def test_users_username_department(self,data_base):
    ...
    def test_users_username_department_all(self,data_base):
        ...
        all_coincidence={}
        for key in users:
            if ('ov' in users[key]['username']) and ('qual' in users[key]['department']):
                all_coincidence[key]=users[key]
        if r==str(all_coincidence):
            logs(func_name,passed)
        else:
    ...
    def test_department_unic(self,data_base):
    ...
    def test_department_name(self,data_base):
    ...
    def test_department_name_all(self,data_base):
        ...
        all_coincidence=[]
        for key in users:
            if ('qual' in users[key]['department']) and (users[key]['department'] not in all_coincidence):
                all_coincidence.append(users[key]['department'])
        if r==str(all_coincidence):
            logs(func_name,passed)
        else:
            logs(func_name,failed,'В ответе не все совпадения')
